...
namespace Du_an {
    ...
    public class Bc_DonDat : ReportClass {
    ...
    public class CachedBc_DonDat : Component, ICachedReport {
        
        public CachedBc_DonDat() {
        }
