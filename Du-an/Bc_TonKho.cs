...
namespace Du_an {
    ...
    public class Bc_TonKho : ReportClass {
    ...
    public class CachedBc_TonKho : Component, ICachedReport {
        
        public CachedBc_TonKho() {
        }
