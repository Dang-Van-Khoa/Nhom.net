...
namespace Du_an {
    ...
    public class Bc_SanPham : ReportClass {
    ...
    public class CachedBc_SanPham : Component, ICachedReport {
        
        public CachedBc_SanPham() {
        }
