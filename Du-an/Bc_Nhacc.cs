...
namespace Du_an {
    ...
    public class Bc_Nhacc : ReportClass {
    ...
    public class CachedBc_Nhacc : Component, ICachedReport {
        
        public CachedBc_Nhacc() {
        }
