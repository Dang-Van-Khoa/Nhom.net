...
namespace Du_an {
    ...
    public class Bc_GDich : ReportClass {
    ...
    public class CachedBc_GDich : Component, ICachedReport {
        
        public CachedBc_GDich() {
        }
