...
namespace Du_an {
    ...
    public class Bc_Danhmuc : ReportClass {
    ...
    public class CachedBc_Danhmuc : Component, ICachedReport {
        
        public CachedBc_Danhmuc() {
        }
