...
namespace Du_an {
    ...
    public class Bc_NguoiDung : ReportClass {
    ...
    public class CachedBc_NguoiDung : Component, ICachedReport {
        
        public CachedBc_NguoiDung() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Bc_NguoiDung rpt = new Bc_NguoiDung();
            rpt.Site = this.Site;
            return rpt;
        }
